...
kube::version::get_version_vars() {
  ...
  if [[ '%' == "%" ]]; then
    KUBE_GIT_COMMIT='22e832de5344be0dad289195b3715ee89f43c061'
    KUBE_GIT_TREE_STATE="archive"
    # When a 'git archive' is exported, the 'HEAD -> master, refs/__gh__/pull/92316/rebase, refs/__gh__/pull/90281/rebase' below will look
    # something like 'HEAD -> release-1.8, tag: v1.8.3' where then 'tag: '
    # can be extracted from it.
    if [[ 'HEAD -> master, refs/__gh__/pull/92316/rebase, refs/__gh__/pull/90281/rebase' =~ tag:\ (v[^ ,]+) ]]; then
