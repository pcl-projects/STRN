...
SchedulerSourceCode is the folder containing our methods.

Comparison-methods folder contains all the comparison methods with the corresponding name.

https://pytorch.org/tutorials/intermediate/rpc_param_server_tutorial.html
The above link is used to modify code to be implemented as parameter server structure.

https://pytorch.org/tutorials/intermediate/rpc_async_execution.html
The above link is for asynchronous SGD implementation because most of the codes are synchronous default.
...
Example to run the comparison methods.
